function [PHTelem,controlPts,dimBasis, ...
          field,...
          numberElements,markRef] = refineElemProjField(elemRef,PHTelem, ...
          controlPts,geometry,dimBasis, dim, ...
          field, ...
          numberElements)
...
for i=1:length(elemRef)
    if elemRef(i)
        ...
        if isempty(PHTelem(curElem).children)
            ...
            [PHTelem, controlPts, dimBasis, ...
                field] = crossInsertProjIsoField(PHTelem, ...
                controlPts,curElem,dimBasis,p,q, dim, ...
                field);
