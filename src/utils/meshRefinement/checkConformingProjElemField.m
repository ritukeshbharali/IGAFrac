function [PHTelem,controlPts,meshInfo, ...
          field, ...
          markRef] = checkConformingProjElemField(PHTelem,controlPts,...
          meshInfo,geometry,field, ...
          markRef)
            ...
            if ~isempty(indexElemA)
                ...
                [PHTelem{patchA},controlPts{patchA},meshInfo.dimBasis(patchA), ...
                 ...
                 meshInfo.numberElements,markRefTemp] = ...
                    refineElemProjField(elemRefA, PHTelem{patchA},controlPts{patchA}, ...
                 geometry,meshInfo.dimBasis(patchA), ...
                 geometry.dim,field{patchA}, ...
