function [PHTelem,controlPts,dimBasis,field] = crossInsertProjIsoField(PHTelem, ...
         controlPts,elm_index,dimBasis,p,q,dim, ...
         field)
...
switch dim
    ...
    case 2
        ...
        coordinates  = [controlPts, field.X];
        coordinates1 = [controlPts, field.Y];
        coordinates2 = [controlPts, field.Phi];
        
    case 3
        
        coordinates  = [controlPts, field.X];
        coordinates1 = [controlPts, field.Y];
        coordinates2 = [controlPts, field.Z];
        coordinates3 = [controlPts, field.Phi];
...
switch dim
    ...
    case 2
        ...
        field.X   = coordinates(:,4:end);
        field.Y   = coordinates1(:,4:end);
        field.Phi = coordinates2(:,4:end);
        
    case 3
        
        field.X   = coordinates(:,4:end);
        field.Y   = coordinates1(:,4:end);
        field.Z   = coordinates2(:,4:end);
        field.Phi = coordinates3(:,4:end);
