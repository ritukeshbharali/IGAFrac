function [PHTelem,controlPts,dimBasis,numberElements,markRef] = refineElemGradedIso(elemRef,PHTelem,controlPts,p,q,dimBasis,numberElements)
...
for i=1:length(elemRef)
    if elemRef(i)
        ...
        if isempty(PHTelem(curElem).children)
            ...
            [PHTelem, controlPts, dimBasis] = crossInsert(PHTelem, controlPts,curElem,dimBasis,p,q);
