function [PHTelem,controlPts,dimBasis,fieldData,numberElements,markRef] = refineElemProj(elemRef,PHTelem,controlPts,geometry,dimBasis,fieldData,numberElements)
